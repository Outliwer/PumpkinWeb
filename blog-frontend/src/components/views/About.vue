<template>
  <div class="about">
    ...
    <p class="name">竹马</p>
    <p class="desc">Stay hungry, Stay foolish.</p>
    <ul class="social">
      <li><a href="https://github.com/Outliwer" target="_blank"><img src="../../assets/icon/GitHub.png" alt=""></a></li>
    </ul>
    <div class="line"></div>
    <h4>技能值</h4>
    <div class="progresses">
      ...
      <iv-row :gutter="20">
        ...
        <iv-col :span="18">
          <iv-progress status="wrong" :hide-info="true" :stroke-width="8" :percent="20" class="bar"></iv-progress>
        </iv-col>
      </iv-row>
    </div>
  </div>
